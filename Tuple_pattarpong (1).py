...
print("ตำแหน่งของยี่ห้อ Benz คือ",brand_cars.index("Benz"))
print("ตำแหน่งของ Tesla คือ",brand_cars.index("Tesla"))
...
print("มียี่ห้อรถ Tesla อยู่ใน brand_cars หรือไม่ =","Tesla" in brand_cars)
